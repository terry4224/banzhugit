  ...
  <div class="bbox">
    ...
    >
      ...
      <el-table-column
        ...
        width="120"
      ></el-table-column>
      <el-table-column label="项目内容" width="800" prop="projectContent">
      </el-table-column>
      <el-table-column label="计划年度" width="120" prop="planYear">
      </el-table-column>
      <el-table-column label="总投资不含(万元)" width="120" prop="totalInvestmentExcTax">
      </el-table-column>
      ...
      <el-table-column label="实际验收时间" width="120" prop="actualInspectTime">
      </el-table-column>
      <el-table-column
        label="计划结算审计时间"
        width="120"
      ...
      <el-table-column label="结余(万元)" width="120" prop="balance">
      </el-table-column>
      <el-table-column label="已挂账(不含税，万元)" width="120" prop="creditedAmount">
      </el-table-column>
      <el-table-column
        label="待挂账(不含税，万元)"
        width="120"
...
const projectnames5 = ref(); // 定义父传递项目名称
const labelname5 = ref(); // 定义父传递lablename
...
watchEffect(() => {
  ...
  labelname5.value = props.labelname5;
  projectnames5.value = props.projectnames5;
});
...
const uuu = async () => {
  let res = await getData({
    method: "post",
    url: "/mgr/project-milepost/milepost5/page",
    data: {
      data: {
        projectName:projectnames5.value,
      },
...
//  监听是否被点击
watch(()=>labelname5.value,()=>{
 uuumounted();
})
// 监听项目名称是否改变
watch(()=>projectnames5.value,(newvalue,oldvalue)=>{
  uuu();
})
onMounted(()=>{
   uuumounted();
