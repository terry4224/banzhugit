  ...
  <div class="bbox">
    ...
    >
      ...
      <el-table-column
        ...
        width="120"
      ></el-table-column>
      <el-table-column label="2022年计划金额" width="120" prop="planAmountYear">
      </el-table-column>
      <el-table-column
        label="2022年预算金额"
        width="120"
        prop="budgetAmountYear"
      >
      </el-table-column>
      <el-table-column
        label="采购提报时间"
        width="120"
        prop="purchaseCommitTime"
      >
      </el-table-column>
      ...
      <el-table-column
        label="专项运维(第一次进度报告)"
        width="120"
        prop="devopsFirstReportDate"
      >
      </el-table-column>
      <el-table-column
        label="专项运维(第二次进度报告)"
        width="120"
        prop="devopsSecondReportDate"
      >
      </el-table-column>
      <el-table-column
        label="年度运维(一季度)"
        width="120"
        prop="devopsFirstQuarter"
      >
      </el-table-column>
      <el-table-column
        label="年度运维(二季度)"
        width="120"
        prop="devopsSecondQuarter"
      >
      </el-table-column>
      <el-table-column
        label="年度运维(三季度)"
        width="120"
        prop="devopsThirdQuarter"
      >
      </el-table-column>
      <el-table-column
        label="年度运维(四季度)"
        width="120"
        prop="devopsForthQuarter"
      >
      </el-table-column>
...
const projectnames3 = ref(); // 定义父传递项目名称
const labelname3 = ref(); // 定义父传递lablename
...
watchEffect(() => {
  ...
  labelname3.value = props.labelname3;
  projectnames3.value = props.projectnames3;
});
...
const uuu = async () => {
  let res = await getData({
    method: "post",
    url: "/mgr/project-milepost/milepost3/page",
    data: {
      data: {
        projectName: projectnames3.value,
      },
